...
from django.core.exceptions import (
    ValidationError,
)  # allows your model to reject invalid data with a meaningful message
from django.db import models  # imports Django’s database modeling tools.
from django.db.models import (
    Q,
)  # Q object represents a database condition.Q is used inside database constraints.
...
class DoctorWorkingHour(models.Model):  # This model stores a doctor’s working period for a particular weekday.
    ...
    def __str__(self) -> str:
        ...
        return f"{self.doctor} - {weekday.label} {self.start_time} to {self.end_time}"
